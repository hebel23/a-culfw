// Support for Finesell 868MHz FSK protocol
// author: hebel23@web.de
// modified base from intertechno implementation by O.Droegehorn DHS-Computertechnik GmbH
...
const PROGMEM const uint8_t CC1100_FINESELL_CFG[EE_CC1100_CFG_SIZE] =
    {
...
static void it_send(char *in, uint8_t datatype)
{
...
void it_func(char *in)
{
    ...
    { // Reset Frequency back to Eeprom value
#ifdef USE_RF_MODE
